...
- Resolves the TypeScript the project declares, including dependencies aliased to typescript, so a TypeScript 7 alias next to a TypeScript 6 API shim is picked up under any package manager.
